# Content Topic Queue — VMwareMadeSimple.com

> The 9B overnight shift picks the next unwritten topic and drafts it.
> Quill polishes (MWF), Flounder fact-checks (Tue/Thu/Sat), Publisher stages (daily).
> Rob reviews and git pushes to publish.
